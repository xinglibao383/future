...
def append_csv(csv_path, noise_steps, noise_std, data):
    ...
    with open(csv_path, "a", newline="", encoding="utf-8") as f:
        csv.writer(f).writerow([ns, noise_std, *data])


def accumulate_error(checkpoint_filepath=None, noise_steps=None, noise_std=0.0):
    ...
    logger.record([f'备注: 累积误差实验, noise_steps={noise_steps}, noise_std={noise_std}'])
