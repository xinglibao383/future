...
if __name__ == "__main__":
    hidden_dim, num_layers, dropout, window_size, stride, batch_size, mask_ratio, lr, weight_decay, num_epochs = 128, 2, 0.3, 250, 25, 512, 0.15, 1e-3, 1e-4, 500
